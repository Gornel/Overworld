		...
		if (Input.GetButtonDown ("Fire1")) {
			...
			if (Physics.Raycast (l_Ray, l_RaycastHit, Mathf.Infinity)) {
				...
				if (l_RaycastHit.rigidbody == null) {
					...
					var l_ProjectorRotation = ProjectorRotationUtility.ProjectorRotation (Camera.main.transform.forward, Vector3.up);
					...
					if (l_TerrainCollider != null) {
						...
						if (l_Terrain != null) {
							...
							var l_TerrainToDecalsMatrix = m_WorldToDecalsMatrix * Matrix4x4.TRS (l_Terrain.transform.position, Quaternion.identity, Vector3.one);
