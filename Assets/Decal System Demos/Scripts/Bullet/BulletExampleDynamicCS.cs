...
public class BulletExampleDynamicCS : MonoBehaviour {
				...
				if (l_RaycastHit.rigidbody == null) {
					...
					if (l_TerrainCollider != null) {
						...
						if (l_Terrain != null) {
							...
							DecalProjector l_TerrainDecalProjector = new DecalProjector (l_ProjectorPosition, l_ProjectorRotation, decalScale, cullingAngle, meshOffset, m_UVRectangleIndex, m_UVRectangleIndex);
						...
						// Dynamic object case.
					BulletExampleDynamicObjectCS l_BulletExampleDynamicObject = l_RaycastHit.collider.GetComponent <BulletExampleDynamicObjectCS> ();
